...
Veja o arquivo de exemplo [Exemplo1.md](aux/Exemplo1.md):

```{r echo=FALSE}
cat(system("cat aux/Exemplo1.md", intern = TRUE), sep = "\n")
```
...
```{r}
pandoc(input = "aux/Exemplo1.md", format = "html")
```

Em ambos os casos, o resultado pode ser visualizado ao abrir o arquivo
[Exemplo1_utf8.html](aux/Exemplo1_utf8.html) no navegador.
